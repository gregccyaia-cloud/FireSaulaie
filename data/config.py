...
PNG_DIR=ROOT/'results'/'png';CSV_DIR=ROOT/'results'/'csv';REPORT_DIR=ROOT/'results'/'reports';LOG_DIR=ROOT/'logs';ASSET_DIR=ROOT/'data'/'assets'
DURATION_MIN=120.;DT_S=5.;READ_TIMES=(15,30,60,90,120);FLAME_HEIGHTS=(10.,12.,15.)
GENERATE_REPORT=True;SHOW_PLOTS=False;VERBOSE=True;REPORT_FILENAME='Rapport_V1_4_Consolide.docx'
