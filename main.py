...
def main():
 ...
 ctx={'assets_intro':assets,'cerema':ASSETS/'extrait_cerema_choix_courbes.png','fire':firep,'geom':geomp,'intrados':ASSETS/'ZZ_approxim intrados demi-coupe.png','f10':f10,'f11':f11,'retained':retained,'params':params,'geometry':geometry,'steps':steps,'worst':worst,'integration':ip,'annex':annex,'choice':'En appui du guide Cerema, les courbes CN - ISO 834 et feu extérieur sont étudiées séparément puis comparées.','moa':'Il appartient au maître d’ouvrage ou à son AMO de confirmer à la MOE si la courbe HC doit également être étudiée.','cp':'La chaleur spécifique ca dépend de θa et est recalculée à chaque pas selon la NF EN 1993-1-2.'}
