"""Paramètres de l'étude thermique V1.5 autonome."""
from dataclasses import dataclass
from pathlib import Path
ROOT=Path(__file__).resolve().parent
ASSETS_DIR=ROOT/'assets'; RESULTS_DIR=ROOT/'results'
SHOW_PLOTS=False; GENERATE_REPORT=True; VERBOSE=True
REPORT_FILENAME='Rapport_incendie_V1_5_A.docx'
T_MAX_MIN=120.; DT_SECONDS=5.; READ_TIMES_MIN=(15.,30.,60.,90.,120.)
AMBIENT_C=20.; ALPHA_C=25.; EPSILON_M=.7; EPSILON_F=1.; PHI=1.; K_SH=1.; SIGMA=5.67e-8; RHO_STEEL=7850.
TRUCK_LENGTH_M=16.; TRUCK_WIDTH_M=2.5; TRUCK_HEIGHT_M=4.; FIRE_LENGTHS_M=(10.,15.,20.)
@dataclass(frozen=True)
class CircularElement: name:str; diameter_m:float; exposed_fraction:float=1.
HANGER=CircularElement('Suspente secondaire',.042); CABLE=CircularElement('Câble principal clos',.132)
@dataclass(frozen=True)
